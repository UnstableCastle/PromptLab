...
declare type BaseMuiOtpInputProps = {
    value?: string;
    length?: number;
    autoFocus?: boolean;
...
export declare const MuiOtpInput: default_2.ForwardRefExoticComponent<Omit<MuiOtpInputProps, "ref"> & default_2.RefAttributes<unknown>>;
